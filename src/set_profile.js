...
router.post('/submit_user_info', (req, res) => {
  ...
  router.post('/',urlencodedParser, function (req, res) {
    ...
    con.query("UPDATE user_profile SET gender = ?, pref_gender = ?, bio = ?, age = ?, latitude = ?, longitude = ? WHERE username = ?", [gender, pref_gender, bio, age, latitude, longitude, req.session.user], function (err, result) {
      if (err) {
